...
class SecurityController extends AbstractController
{
     ...
     */
    public function create(Request $request, UserPasswordEncoderInterface $encoder, EntityManagerInterface $entityManager)
    {
        $user = new User();
     ...
     //   $form->handleRequest($request);
      ...
      //  }
        ...
        return $this->render('User/create.html.twig', [
            'User' => $form->createView(),  'conges' => $conges, 
        ]);
    }
    ...
    public function getUsers()
    {
        $users = $this->getDoctrine()
            ->getRepository(User::class)
            ->findAll();
        return $this->render('User/create1.html.twig', ['users' => $users]);
    }
